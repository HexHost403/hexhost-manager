...
banner() {
  ...
  echo
  border
  center " _   _ _______  __ _   _  ___  ____ _____ " "$CYAN"
  center "| | | | ____\ \/ /| | | |/ _ \/ ___|_   _|" "$CYAN"
  center "| |_| |  _|  \  / | |_| | | | \___ \ | |  " "$CYAN"
  center "|  _  | |___ /  \ |  _  | |_| |___) || |  " "$CYAN"
  center "|_| |_|_____/_/\_\|_| |_|\___/|____/ |_|  " "$CYAN"
  center "ᴍᴀᴅᴇ ʙʏ : ɪᴍᴍᴜ" "$GRAY"
  border
  echo
}
