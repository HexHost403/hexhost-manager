...
banner() {
  ...
  if [ "$cols" -lt 74 ]; then
    ...
    echo -e "             ${GRAY}${BOLD}MADE BY : IMMU${RESET}"
    echo -e "${RED}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
  else
    echo -e "${RED}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    echo -e "${CYAN}${BOLD}"
    ...
    echo -e "${RESET}"
    echo -e "                ${WHITE}${BOLD}🚀 HEXHOST MANAGER TOOL${RESET}"
    echo -e "                     ${WHITE}${BOLD}MADE BY : IMMU${RESET}"
    echo -e "${RED}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
  fi
...
install_panel() {
  ...
  run_silent "Downloading Panel" "rm -rf $PANEL_DIR && mkdir -p $PANEL_DIR && cd $PANEL_DIR && curl -Lo panel.tar.gz https://github.com/pterodactyl/panel/releases/latest/download/panel.tar.gz && tar -xzf panel.tar.gz && chmod -R 755 storage/* bootstrap/cache/ && cp .env.example .env" || { pause; return; }

  run_silent "Creating database" "mysql -u root -e \"DROP DATABASE IF EXISTS panel; CREATE DATABASE panel CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; DROP USER IF EXISTS 'pterodactyl'@'127.0.0.1'; DROP USER IF EXISTS 'pterodactyl'@'localhost'; CREATE USER 'pterodactyl'@'127.0.0.1' IDENTIFIED BY '$DB_PASS'; CREATE USER 'pterodactyl'@'localhost' IDENTIFIED BY '$DB_PASS'; GRANT ALL PRIVILEGES ON panel.* TO 'pterodactyl'@'127.0.0.1' WITH GRANT OPTION; GRANT ALL PRIVILEGES ON panel.* TO 'pterodactyl'@'localhost' WITH GRANT OPTION; FLUSH PRIVILEGES;\"" || { pause; return; }
